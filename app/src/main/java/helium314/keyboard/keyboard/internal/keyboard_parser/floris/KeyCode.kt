...
object KeyCode {
    ...
    const val VOICE_TRANSCRIBE_TOGGLE =   -10080
    const val VOICE_START_STOP =          -10081
    const val VOICE_CANCEL =              -10082
    const val VOICE_INSERT =              -10083
    const val VOICE_REFORMAT =            -10084
    const val VOICE_COPY =                -10085
    ...
    fun Int.checkAndConvertCode(): Int = if (this > 0) this else when (this) {
        ...
        VOICE_TRANSCRIBE_TOGGLE, VOICE_START_STOP, VOICE_CANCEL, VOICE_INSERT, VOICE_REFORMAT, VOICE_COPY
        -> this
